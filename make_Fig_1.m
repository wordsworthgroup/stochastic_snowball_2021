...
subplot(2,2,1)
plot(solver.t_a,solver.y_a(:,ir_snow)*climate.fCO20,'k'); hold on
plot(solver.t_a,ym_a,'Color',[0.5 1 0.5]*0.75,'LineWidth',1.5)
xlabel('t [My]'); ylabel('f_{CO2} [ppmv]')
axis([0 500 0 2*climate.chi*climate.fCO20])

% display T time series
subplot(2,2,3)
plot(solver.t_a,x_a(:,ir_snow)+climate.T0,'k'); hold on
plot(solver.t_a,xm_a,'Color',[0.5 1 0.5]*0.85,'LineWidth',1.5)
